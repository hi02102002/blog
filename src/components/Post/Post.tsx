...
const Post = ({ post }: Props) => {
  return (
    <div className="flex md:items-center gap-4 p-4 rounded hover:bg-neutral-100 transition duration-300 cursor-pointer group md:flex-row flex-col border-2 border-transparent border-dashed hover:border-neutral-400">
      ...
      <div>
        ...
        {post.description && (
          <p className="text-neutral-600 line-clamp-3 mb-2">
            {post.description}
          </p>
        )}
        <div className="flex items-center gap-4 text-sm text-neutral-600">
          ...
          <div className="flex items-center gap-1 leading-none">
            ...
            <span className="leading-none text-inherit">{post.read_time}</span>
          </div>
        </div>
      </div>
    </div>
